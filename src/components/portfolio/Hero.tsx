...
>
  ...
  >
    <motion.div
      ...
      className="hidden md:block absolute top-8 -left-5 px-4 py-2 rounded-xl font-medium"
      style={{ background: "color-mix(in oklab, var(--text-primary) 12%, transparent)", border: "1px solid var(--accent)", backdropFilter: "blur(14px)", color: "var(--text-primary)" }}
    >
    ...
    <motion.div
      variants={{ hidden: { opacity: 0, y: 8, scale: 0.98 }, visible: { opacity: 1, y: 0, scale: 1 } }}
      transition={{ duration: 0.6, ease: "easeOut" }}
      className="hidden md:block absolute top-45 -right-1 px-4 py-2 rounded-xl font-medium"
      style={{ background: "color-mix(in oklab, var(--text-primary) 12%, transparent)", border: "1px solid var(--accent)", backdropFilter: "blur(14px)", color: "var(--text-primary)" }}
    >
      🤖 An AI Engineer
    </motion.div>
    ...
    <motion.div
      variants={{ hidden: { opacity: 0, y: 8, scale: 0.98 }, visible: { opacity: 1, y: 0, scale: 1 } }}
      transition={{ duration: 0.6, ease: "easeOut" }}
      className="hidden md:block absolute bottom-10 -right-10 px-4 py-2 rounded-xl font-medium"
      style={{ background: "color-mix(in oklab, var(--text-primary) 12%, transparent)", border: "1px solid var(--accent-secondary)", backdropFilter: "blur(14px)", color: "var(--text-primary)" }}
    >
      ⚡ A Flutter Developer
    </motion.div>
    ...
    <motion.div
      variants={{ hidden: { opacity: 0, y: 8, scale: 0.98 }, visible: { opacity: 1, y: 0, scale: 1 } }}
      transition={{ duration: 0.6, ease: "easeOut" }}
      className="hidden md:block absolute bottom-40 -left-20 px-4 py-2 rounded-xl font-medium"
      style={{ background: "color-mix(in oklab, var(--text-primary) 12%, transparent)", border: "1px solid var(--accent-secondary)", backdropFilter: "blur(14px)", color: "var(--text-primary)" }}
    >
